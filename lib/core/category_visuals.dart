...
class CategoryVisuals {
  ...
  static const Map<String, IconData> _icons = {
    ...
    'Nature & Écologie': Icons.park_rounded,
    'Nature & Ecology': Icons.park_rounded,
    ...
    'Couture & Tricot': Icons.content_cut_rounded,
    'Sewing & Craft': Icons.content_cut_rounded,
    'Documentaire': Icons.video_library_rounded,
    'Documentary': Icons.video_library_rounded,
    'Religion & Foi': Icons.church_rounded,
    'Religion & Faith': Icons.church_rounded,
    ...
    'Crypto & Web3': Icons.currency_bitcoin_rounded,
    'Langues': Icons.translate_rounded,
    'Languages': Icons.translate_rounded,
    'Histoire': Icons.history_edu_rounded,
    'History': Icons.history_edu_rounded,
    'Art': Icons.palette_rounded,
    'Photo & Vidéo': Icons.camera_alt_rounded,
    'Photo & Video': Icons.camera_alt_rounded,
    'Outdoor & Aventure': Icons.terrain_rounded,
    'Outdoor & Adventure': Icons.terrain_rounded,
    'Psychologie': Icons.psychology_rounded,
    'Psychology': Icons.psychology_rounded,
    'Luxe & Lifestyle': Icons.diamond_rounded,
    ...
    'Cosplay & Geek': Icons.star_rounded,
    ...
    'Sports Extrêmes': Icons.downhill_skiing_rounded,
    'Extreme Sports': Icons.downhill_skiing_rounded,
    'Nutrition & Diète': Icons.local_dining_rounded,
    'Nutrition & Diet': Icons.local_dining_rounded,
    'Vintage & Rétro': Icons.watch_rounded,
    'Vintage & Retro': Icons.watch_rounded,
    'Fails & Compilations': Icons.videocam_rounded,
  };
  ...
  static const Map<String, Color> _lightBadgeBackground = {
    ...
    'Religion & Foi': Color(0xFFB9A1E8),
    'Religion & Faith': Color(0xFFB9A1E8),
    ...
    'Couture & Tricot': Color(0xFFE095D6),
    'Sewing & Craft': Color(0xFFE095D6),
    ...
    'Déco & Home': Color(0xFFE0C9A6),
    'Home Decor': Color(0xFFE0C9A6),
    'Auto & Moto': Color(0xFF9BB8E8),
    'Conduite': Color(0xFF9BB8E8),
    'Cinéma & Séries': Color(0xFFF5B8A8),
    ...
    'Nature & Écologie': Color(0xFF82D9C6),
    'Nature & Ecology': Color(0xFF82D9C6),
    ...
    'Crypto & Web3': Color(0xFFF7DC6F),
    'Langues': Color(0xFFA8D8E8),
    'Languages': Color(0xFFA8D8E8),
    'Art': Color(0xFFE080E0),
    'Photo & Vidéo': Color(0xFF8FC9E8),
    'Photo & Video': Color(0xFF8FC9E8),
    'Outdoor & Aventure': Color(0xFF9ED9A0),
    'Outdoor & Adventure': Color(0xFF9ED9A0),
    'Psychologie': Color(0xFFB0B8F0),
    'Psychology': Color(0xFFB0B8F0),
    'Luxe & Lifestyle': Color(0xFFF0D080),
    'Luxury & Lifestyle': Color(0xFFF0D080),
    'Entrepreneuriat': Color(0xFF8ED0C8),
    'Entrepreneurship': Color(0xFF8ED0C8),
    'Éducation': Color(0xFF8FB8F0),
    'Education': Color(0xFF8FB8F0),
    'Cosplay & Geek': Color(0xFFC0A0F0),
    'Danse': Color(0xFFF28FC0),
    'Dance': Color(0xFFF28FC0),
    'Jardinage': Color(0xFFA8D084),
    'Gardening': Color(0xFFA8D084),
    'Sports Extrêmes': Color(0xFFF29060),
    'Extreme Sports': Color(0xFFF29060),
    'Nutrition & Diète': Color(0xFFA0DDB0),
    'Nutrition & Diet': Color(0xFFA0DDB0),
    'Vintage & Rétro': Color(0xFFD0C0A8),
    'Vintage & Retro': Color(0xFFD0C0A8),
    'Fails & Compilations': Color(0xFFF09090),
  };
  ...
  static const Map<String, Color> _lightBadgeForeground = {
    ...
    'Religion & Foi': Color(0xFF382255),
    'Religion & Faith': Color(0xFF382255),
    ...
    'Couture & Tricot': Color(0xFF54204D),
    'Sewing & Craft': Color(0xFF54204D),
    ...
    'Déco & Home': Color(0xFF4A3311),
    'Home Decor': Color(0xFF4A3311),
    'Auto & Moto': Color(0xFF1A2F57),
    'Conduite': Color(0xFF1A2F57),
    'Cinéma & Séries': Color(0xFF5C2417),
    ...
    'Nature & Écologie': Color(0xFF0E4A3C),
    'Nature & Ecology': Color(0xFF0E4A3C),
    ...
    'Crypto & Web3': Color(0xFF4A3E00),
    'Langues': Color(0xFF143A47),
    'Languages': Color(0xFF143A47),
    'Art': Color(0xFF4A1A4A),
    'Photo & Vidéo': Color(0xFF12374A),
    'Photo & Video': Color(0xFF12374A),
    'Outdoor & Aventure': Color(0xFF1C4A22),
    'Outdoor & Adventure': Color(0xFF1C4A22),
    'Psychologie': Color(0xFF26295E),
    'Psychology': Color(0xFF26295E),
    'Luxe & Lifestyle': Color(0xFF4A3800),
    'Luxury & Lifestyle': Color(0xFF4A3800),
    'Entrepreneuriat': Color(0xFF12473F),
    'Entrepreneurship': Color(0xFF12473F),
    'Éducation': Color(0xFF132C57),
    'Education': Color(0xFF132C57),
    'Cosplay & Geek': Color(0xFF33174A),
    'Danse': Color(0xFF4A1230),
    'Dance': Color(0xFF4A1230),
    'Jardinage': Color(0xFF2C4A13),
    'Gardening': Color(0xFF2C4A13),
    'Sports Extrêmes': Color(0xFF4A2400),
    'Extreme Sports': Color(0xFF4A2400),
    'Nutrition & Diète': Color(0xFF1C4A2C),
    'Nutrition & Diet': Color(0xFF1C4A2C),
    'Vintage & Rétro': Color(0xFF3A2F1C),
    'Vintage & Retro': Color(0xFF3A2F1C),
    'Fails & Compilations': Color(0xFF4A1414),
  };
